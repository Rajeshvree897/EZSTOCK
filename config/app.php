...
return [
    ...
    'ENCOMPASS_LOGIN_API' => env('ENCOMPASS_LOGIN_API', 'https://encompass.com/restfulservice/jsonWebItemInformation'),

     'ENCOMPASS_ORDER_STATUS_API' => env('ENCOMPASS_ORDER_STATUS_API', 'https://encompass.com/restfulservice/orderStatus'),
     'GOOGLE_NOTOFICATION' => env('GOOGLE_NOTOFICATION', 'https://fcm.googleapis.com/fcm/send'),
    /*
    |--------------------------------------------------------------------------
    | Application Name
    |--------------------------------------------------------------------------
